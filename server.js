...
const appServer = require('./dist/client/platform-server/main.bundle');
...
app.use(express.static(`${__dirname}/dist/client/platform-browser`));
...
app.set('views', 'dist/client/platform-browser');
